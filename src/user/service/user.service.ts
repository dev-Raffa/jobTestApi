...
import { userAddArgs, userDeleteArgs, userGetOneByIdArgs, userUpdateArgs } from '../model/user.args';
...
export class UserService {
    ...
    async update(args: userUpdateArgs): Promise<userEntity>{
        await this.repository.update(args.id, {
            ...(args.email && {email: args.email}),
            ...(args.password && {password: args.password}),
            ...(args.uuid && {uuid: args.uuid}),
            ...(args.enrolledInCourses && { enrolledInCourses: args.enrolledInCourses}),
