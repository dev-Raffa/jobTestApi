...
import { classAddArgs, classDeleteArgs, classGetOneByIdArgs, classUpdateArgs } from '../model/class.args';
...
export class ClassService {
    ...
    async update(args: classUpdateArgs): Promise<ClassEntity>{
        await this.repository.update(args.id, {
            ...(args.title &&{title: args.title}),
            ...(args.description &&{description: args.description}),
            ...(args.type &&{type: args.type}),
            ...(args.url &&{url: args.url}),
            ...(args.professor &&{professor: args.professor}),
        })
